...
namespace CombatCore.SAT
{
    ...
    {
        // 平面方程: Normal · P = Offset
        // Normal 是平面的法向量
        // P 是平面上的任意一点
        // Offset 是平面上任意一点在 Normal 方向上的投影值
        // 如果 Normal 是单位向量，则 Offset 才表示原点到平面的有符号距离

        /// <summary>
        /// 平面法向量 表示平面相对于 hull 原点的方向
        /// </summary>
